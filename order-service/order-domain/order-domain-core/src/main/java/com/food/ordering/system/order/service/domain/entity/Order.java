...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void pay() {
        if(orderStatus != OrderStatus.PENDING) {
            throw new OrderDomainException("Order should be pending to proceed with payment");
        }
    ...
    public void approve() {
        if(orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Order should be paid to proceed with approval");
        }
    ...
    public void initCancel(List<String> failureMessages) {
        if(orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Order should be paid to proceed initialize a cancelling request");
        }
